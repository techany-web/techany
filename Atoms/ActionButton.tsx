    ...
    <>
      <a href={url}>
        <button
          className={
            style === "primary"
              ? "bg-rose-500 text-white text-xs px-2 py-2 uppercase font-medium rounded-full hover:bg-purple-900 duration-500 md:text-sm md:uppercase md:mx-2 md:bg-purple-500 md:hover:bg-purple-900 md:px-5 md:py-2"
